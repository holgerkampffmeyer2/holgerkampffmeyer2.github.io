...
const keyFilePath = path.join(__dirname, '../public/a5337f1aa7804e5a9b9f2204ee7b203a.txt');
...
const payload = {
  host: 'holger-kampffmeyer.de',
  key: apiKey,
  keyLocation: 'https://holger-kampffmeyer.de/a5337f1aa7804e5a9b9f2204ee7b203a.txt',
  urlList: urls
};
